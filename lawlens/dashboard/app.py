...
# Language code mapping (abbreviated for example)
lang_code_map = {
    "English": "en", "Hindi": "hi", "Spanish": "es", "French": "fr", 
    "German": "de", "Chinese (Simplified)": "zh-cn", "Arabic": "ar"
    # Add all other languages with their codes
}

st.set_page_config(page_title="LawLens with FLAN-T5", layout="wide", page_icon="⚖️")

st.title("⚖️ LawLens with FLAN-T5 + 🌍 Translator")
...
# TAB 1: Legal Document Summarizer
with tabs[0]:
    st.header("FLAN-T5 Legal Document Summarizer")
    ...
    with col2:
        summary_length = st.slider("Summary Length", 150, 750, 512, help="Adjust the length of the summary")
